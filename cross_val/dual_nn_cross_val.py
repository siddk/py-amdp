"""
dual_nn_cross_val.py 

NO STEPS - Add steps later, see if helps.
"""
...
def run_cross_val(data, out, N_10_EPOCHS=5):
    ...
    for i in range(FOLDS):
        ...
        model = NNDual(l0_train, l1_train, l2_train, commands['L0'], commands['L1'], commands['L2'])
...
if __name__ == "__main__":
    ...
    for trial in range(NUM_TRIALS):
        out_path = "%s_dual_nn_results_%s.txt" % ("clean" if clean else "raw", str(trial))
